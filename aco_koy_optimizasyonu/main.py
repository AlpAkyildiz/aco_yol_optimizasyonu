...
# Streamlit Ayarları
# =============================
st.set_page_config(page_title="Köyler Arası Rota Optimizasyonu", layout="wide")
st.title("Karınca Kolonisi ile Köyler için Rota Optimizasyonu")
...
st.markdown("---")
st.caption("🎓 Köyler Arası Rota Optimizasyonu Projesi | ACO + Haversine")
